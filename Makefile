.PHONY: fmt test vet installer-check verify demo codex-smoke trae-smoke build-tools build-realyctl codex-capability-smoke db-up db-down postgres-test clean
